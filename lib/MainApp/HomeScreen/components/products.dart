...
import 'package:fashion_app/details/details_screen.dart';
import 'package:flutter/material.dart';
import 'package:fashion_app/data/data.dart';
class Products extends StatelessWidget {
  Widget _buildProducts(BuildContext context, int index) {
    Size size = MediaQuery.of(context).size;
    ProductModel productModel =  Productss.productsData.productList[index];
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: Productss.productsData.productList.length,
